...
const Profile = ({ navigation }) => {
  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        { icon: isMechanic ? 'construct' : 'car', label: isMechanic ? 'Service' : 'Garage', action: () => navigation.navigate('Garage') },
      ],
    },
  ...
  <Text style={styles.linkButtonText}>View More Details</Text>
</TouchableOpacity>
          </>
        )}
      </View>
